...
//            inputBinding.locationNameInput.val(gmapContext.locationName).change();
            $('#location-picker-input').val(gmapContext.locationName);
            $('#location-picker-input').trigger("focus");
        }
    }
...
//                gmapContext.autocomplete = new google.maps.places.Autocomplete(inputBinding.locationNameInput.get(0));
                gmapContext.autocomplete = new google.maps.places.Autocomplete($('#location-picker-input')[0]);
